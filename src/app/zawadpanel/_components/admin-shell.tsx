...
const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { href: '/zawadpanel/categories', label: 'Categories', icon: LayoutGrid, exact: false },
      { href: '/zawadpanel/brands', label: 'Brands', icon: Tag, exact: false },
      { href: '/zawadpanel/banners', label: 'Banners', icon: Images, exact: false },
      { href: '/zawadpanel/collections', label: 'Collections', icon: Ticket, exact: false },
      { href: '/zawadpanel/pages', label: 'CMS pages', icon: FileText, exact: false },
    ],
  },
]
